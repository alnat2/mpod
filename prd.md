...
- Sequential playback automatically advances to the next selected chapter upon completion; when a top-level item completes, playback starts the first eligible remaining podcast episode or audiobook in playlist order regardless of the completed item's position
